...
# 6. Load Weather and Traffic static tables (FIXED PATHS FOR WSL)
weather_df = spark.read.option("header", "true").csv("file:///mnt/c/Users/RPC/Desktop/projects/DelayDetect/data/weather_data.csv")
traffic_df = spark.read.option("header", "true").csv("file:///mnt/c/Users/RPC/Desktop/projects/DelayDetect/data/traffic_data.csv")
...
# 12. Write final output to parquet files (FIXED PATHS FOR WSL)
output_path = "file:///mnt/c/Users/RPC/Desktop/projects/DelayDetect/output/"
checkpoint_path = "file:///mnt/c/Users/RPC/Desktop/projects/DelayDetect/checkpoints/"
